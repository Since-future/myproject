...
def config():
    ...
    if platform == 'ios':
        res = {
            ...
            'preload_image': 'http://ov2eyt2uw.bkt.clouddn.com/qy_ios.png',   #默认加载图
            'preload_time': 3,
        ...
        res = {
            'lateset_version': '1.0.4',
            'change_log': u'我们优化了部分体验，感谢热烈反馈的书友',
            'download_url': 'http://dl.kdyoushu.com/downloads/kdys.apk',
            'latest_version': 5,
            'force_update': False,
            'preload_image': 'http://ov2eyt2uw.bkt.clouddn.com/android_pre.jpg',  #默认加载图
            'preload_time': 3,
            'preload_expires': 1936988528,
            'timestamp': 4,
